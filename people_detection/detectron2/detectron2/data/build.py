...
def get_detection_dataset_dicts(
    ...
    #print('hello {}'.format(dataset_dicts))
    '''print('{}'.format(names[0]))
    import detectron2.structures.boxes as boxes
    import json
    if names[0] == "historical_train":
        json_file = 'C:\\Users\\chris\\Desktop\\SUS-train-export.json'
        with open(json_file) as f:
            imgs_anns = json.load(f)
    elif names[0] == "historical_val":
        json_file = 'C:\\Users\\chris\\Desktop\\SUS-val-export.json'
        with open(json_file) as f:
            imgs_anns = json.load(f)
    categories = [
    ...
    for image_data in imgs_anns["assets"].values():
        ...
        dataset_dicts[0][count]["annotations"] = annotations
        count += 1'''
