...
def run():
    ...
    evaluator = COCOEvaluator("historical_val", cfg, False, output_dir="./output/")
    #DefaultTrainer.test(cfg, model=trainer.model, evaluators=evaluator)
    val_loader = build_detection_test_loader(cfg, "historical_val")
    inference_on_dataset(trainer.model, val_loader, evaluator)

    from detectron2.utils.visualizer import ColorMode
    dataset_dicts = get_annots("../dataset", "val")
